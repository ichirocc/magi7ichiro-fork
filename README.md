...
**最終更新**：2026-07-26（3.285.0 判断設計監査の改善3件＝結果採用の注記・できあがり度の根拠明示・「データを開く」1世代退避＋復元導線。3.214.0〜3.284.0 の詳細は `CLAUDE.md` の各節に記録）／ **コード基準コミット**：main HEAD（この目次が古いと他が正しくても信頼が崩れるため、改修時は対象文書と本目次を必ず更新）。
