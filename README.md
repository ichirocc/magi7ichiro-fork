...
**最終更新**：2026-07-19（3.213.0 外部レビュー8件修正＝スコアパック1e9化・停滞時計集約/分離・HF63 focus連動・LightMirror希望統一ほか。`CLAUDE.md` に記録）／ **コード基準コミット**：main HEAD（この目次が古いと他が正しくても信頼が崩れるため、改修時は対象文書と本目次を必ず更新）。
