...
**最終更新**：2026-09-06（3.504.0＝外部提示 C# 6 ファイルの優劣検証と移植。希望島ビームを島巡回＋残り予算で頭打ちへ（単体 1 改善/11 不変・後処理 4/4 不変）、C1 ビームのハッシュ鍵 dedup、評価中例外の巻き戻し try/finally。公平分配・枝刈り計上・root 初期化・族ゲートは計測つきで否決。重み不変）
