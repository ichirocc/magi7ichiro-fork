...
**最終更新**：2026-07-26（3.284.0 外部レビュー採用5件＝停止状態固着修正・c3n壁文言の限定・AUTO帯統一・JNI checked cursor・本目次同期。3.214.0〜3.283.1 の詳細は `CLAUDE.md` の各節に記録）／ **コード基準コミット**：main HEAD（この目次が古いと他が正しくても信頼が崩れるため、改修時は対象文書と本目次を必ず更新）。
