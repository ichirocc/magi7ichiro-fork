...
2. 未レビュー領域の精読: ~~`V6LateOperators`~~（3.507.7）/`V6SearchOperators`/`V6HotfixPasses` 各パス内部, CSV/UI 層。**（3.507.7）** `V6PortAnalyzer`（3.503.0）・`V6SwapSuggester`（3.507.4）・`V6SanityPort`（3.507.5）・`V6LateOperators`（3.507.7）は一巡。
